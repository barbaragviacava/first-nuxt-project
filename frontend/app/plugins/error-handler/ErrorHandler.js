...
export default class Errors {
  ...
  constructor(customMessages = null, customDefaultMessage = '', isDev = true, i18n = null) {
    this.errors = {}
  ...
  parse() {
    ...
    let message = this.errorMessages.getErrorMessage(status);
    if (typeof errors == 'object' && errors != null && errors.message) {
    ...
    return {
      status,
      message,
      icon: this.errorMessages.getIcon(status)
    }
  }
